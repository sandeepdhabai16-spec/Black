...
<body>
    ...
    <?php
    if (isset($_GET['mobile']) && preg_match('/^\d{10}$/', $_GET['mobile'])) {
        $mobile = $_GET['mobile'];
        $apis = [
            // Old APIs (20)
            [
            ...
            [
                ...
                "data" => "mobile_no=%2B91" . $mobile . "®istration_source="
            ],
            [
            ...
            [
                ...
                "headers" => [
                    ...
                    "user-agent: Mozilla/5.0 (Linux; Android 10; TECNO KE5 Build/QP1A.190711.020) AppleWebKit/737.36 (KHTML, like Gecko) Chrome/131.0.6778.135 Mobile Safari/537.36",
                    "sec-ch-ua: \"Android WebView\";v=\"131\", \"Chromium\";v=\"131\", \"Not_A Brand\";v=\"24\"",
                    "content-type: application/json",
                    "sec-ch-ua-mobile: ?1",
        ...
        for ($i = 1; $i <= 1; $i++) {
            ...
            foreach ($apis as $api) {
                ...
                echo "<hr>";
                echo "<p><strong>API Name:</strong> " . htmlspecialchars($api['name']) . "</p>";
        ...
        echo "<p style='color:red;'>Invalid mobile number. Please enter a 10-digit number.</p>";
    }
    ?>
</body>
</html>